const checkConditionDetail = {
    ...
    responseListIsEmptyArray: responseList => {
        ...
        if (dataInSteps.method === 'CreateRequest') {
          ...
          if (detail.data_request_list !== null) {
            ...
            if(detail.idp_list.length > newSteps.length) {
                ...
                } else {idpList.push({idp_id:detail.idp_list[0], status: "Not Answer", ial:detail.min_ial, aal:detail.min_aal, idp_fee_ratio:0.5})}
